...
import com.ehl3288.book.springboot.domain.user.Role;
...
public class OAuthAttributes {
   ...
   //OAuth2User에서 반환하는 사용자 정보가 Map이므로 값 하나하나를 변환해야 한다.
   ...
   //user Entity 생성, OAuthAttributes에서 엔티티 생성하는 시점은 처음 가입할 때. 기본은 GUEST로 준다.
